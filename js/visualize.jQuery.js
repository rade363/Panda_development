...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: '*',
			colFilter: '*',
			colors: ['#0099ff','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744'],
		...
		function scrapeTable(){
			...
			var tableData = {
				...
				topValue: function(){
						...
						var n = topValue * 0.1;
						//topValue = topValue + 	parseInt(n.toFixed(), 10);
						return topValue;
				},
			...
			line: function(area){
				...
				$.each(dataGroups,function(h){
					...
					$.each(points, function(){
						...
						ctx.fillRect(integer-5, -(this*yScale)-5, 10, 10);
						integer+=xInterval;
					});
